...
#a6[0][3] = "cba"
print("\n")
k1 = input("Введите день рождения: "), input("Введите месяц рождения: "), input("Введите год рождения: ")
print(k1)
k2 = input("Введите вашу фамилию: "), input("Введите ваше Имя: "), input("Введите ваше отчество: ")
k3 = k1 + k2
print(k3)
k4 = k1 + k2
print(k4[1][1])